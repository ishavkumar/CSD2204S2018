...
MariaDB [csd2204s18]> show countries;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'countries' at line 1
...
MariaDB [csd2204s18]> select location_id,country_id from loactions where country_id='us';
ERROR 1146 (42S02): Table 'csd2204s18.loactions' doesn't exist
...
MariaDB [csd2204s18]> select department_id,location_id from departments where location_id in (select location_id from locations where country_id='us');
+---------------+-------------+
...
MariaDB [csd2204s18]>  select first_name, last_name from employees where manager_id != 0 AND select department_id,location_id from departments where location_id in (select location_id from locations where country_id='us');
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'select department_id,location_id from departments where location_id in (select l' at line 1
MariaDB [csd2204s18]>  select first_name, last_name from employees where manager_id != 0 AND (select department_id,location_id from departments where location_id in (select location_id from locations where country_id='us'));
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]>  select first_name, last_name from employees where manager_id != 0 AND department_id = (select department_id,location_id from departments where location_id in (select location_id from locations where country_id='us'));
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]>  select first_name, last_name from employees where manager_id != 0 AND department_id in (select department_id,location_id from departments where location_id in (select location_id from locations where country_id='us'));
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]>  select first_name, last_name from employees where manager_id != 0 AND department_id in (select department_id,location_id from departments where location_id in (select location_id from locations where country_id='US'));
ERROR 1241 (21000): Operand should contain 1 column(s)
...
MariaDB [csd2204s18]> select employee_id, frist_name, manager_idfrom employees limits 10;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'limits 10' at line 1
MariaDB [csd2204s18]> select employee_id, frist_name, manager_id from employees limits 10;
...
MariaDB [csd2204s18]> select employee_id, frist_name, manager_id from employees limit 10;
...
MariaDB [csd2204s18]> select first(select employee_id, first_name, manager_id from employees limit 10);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '(select employee_id, first_name, manager_id from employees limit 10)' at line 1
MariaDB [csd2204s18]> select first_name from employees where in(select employee_id, first_name, manager_id from employees limit 10);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'in(select employee_id, first_name, manager_id from employees limit 10)' at line 1
MariaDB [csd2204s18]> select first_name from employees (select employee_id, first_name, manager_id from employees limit 10);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '(select employee_id, first_name, manager_id from employees limit 10)' at line 1
MariaDB [csd2204s18]> select first(select employee_id, first_name, manager_id from employees limit 10);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '(select employee_id, first_name, manager_id from employees limit 10)' at line 1
MariaDB [csd2204s18]> select employee_id, first_name, manager_id from employees limit 10;
...
MariaDB [csd2204s18]> select * from employees where salary = (select job_id,min_salary from  jobs);
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]> select * from employees where salary = (select min_salary from  jobs);
ERROR 1242 (21000): Subquery returns more than 1 row
MariaDB [csd2204s18]> select first_name, last_name, salary, job_id from employees e where e.salary = (select min_salary from  jobs j where e.job_id =j.job_id);
+------------+------------+---------+----------+
...
MariaDB [csd2204s18]> select first_name, last_name, salary from employees where salary > (select avg(salary) from employees) and department_id in(select department_id from departments where department_name like'it%');
+------------+-----------+---------+
| first_name | last_name | salary  |
+------------+-----------+---------+
| Alexander  | Hunold    | 9000.00 |
...
MariaDB [csd2204s18]> select * from movies;
+------+--------------------+------------------+------+----------------+--------------+
| ID   | title              | director         | year | length_minutes | bocollection |
+------+--------------------+------------------+------+----------------+--------------+
| 1    | heaven and earth   | maurizio willock | 2004 |            100 |         5.00 |
| 2    | the ufo incident   | dillon dillimore | 2008 |             49 |         5.46 |
| 3    | gambit             | carri garrals    | 2007 |            100 |        53.48 |
| 4    | against the sun    | stacey rives     | 2007 |             91 |        48.68 |
| 5    | room for one more  | coreen friedlos  | 2007 |             80 |         5.00 |
| 6    | paris is burning   | carri garragls   | 1995 |             50 |        26.55 |
| 7    | cars               | john lasseter    | 2003 |             34 |        77.02 |
| 8    | invaders from mars | carri garrals    | 2007 |             50 |        81.73 |
| 9    | train              | andrew stanton   | 2004 |             71 |        81.10 |
| 10   | buried alive       | dillon dillimore | 2009 |            100 |         5.00 |
+------+--------------------+------------------+------+----------------+--------------+
