...
MariaDB [csd2204s18]> select first_name, last_name, salary from meployees where salary > (select salary from employees where last_name like 'bell');
ERROR 1146 (42S02): Table 'csd2204s18.meployees' doesn't exist
...
MariaDB [csd2204s18]> select avg(salary) from jobs;
...
MariaDB [csd2204s18]> select fist_name, last_name, salary from employees where salary> (select avg(salary) from employees);
...
MariaDB [csd2204s18]> select * from employees where salary (select avg(salary) from employees group by department_id);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'select avg(salary) from employees group by department_id)' at line 1
...
MariaDB [csd2204s18]> select first_name, last_name, salary from employees where salary > any(select avg(salary) from employees group by department_id);
+-------------+------------+----------+
| first_name  | last_name  | salary   |
+-------------+------------+----------+
| Steven      | King       | 24000.00 |
...
MariaDB [csd2204s18]> select max(salary), job_id from employees where job_id = 'sh_clerk';
+-------------+----------+
| max(salary) | job_id   |
+-------------+----------+
|     4200.00 | SH_CLERK |
...
MariaDB [csd2204s18]> select first_name, last_name, salary from employees where salary> (select max(salary), job_id from employees where job_id = 'sh_clerk');
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]> select first_name, last_name, salary from employees where salary> (select max(salary), job_id from employees where job_id = 'sh_clerk')order by salary;
ERROR 1241 (21000): Operand should contain 1 column(s)
...
MariaDB [csd2204s18]> select first_name, last_name, salary from employees where salary =< any(select salary from employees where job_id = 'sh_clerk')order by salary;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '< any(select salary from employees where job_id = 'sh_clerk')order by salary' at line 1
MariaDB [csd2204s18]> select first_name, last_name, salary from employees where salary = any(select salary from employees where job_id = 'sh_clerk')order by salary;
+------------+------------+---------+
| first_name | last_name  | salary  |
+------------+------------+---------+
...
MariaDB [csd2204s18]> select distinct(manager_id) from employees where manager_id 1= 0; 
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '1= 0' at line 1
...
MariaDB [csd2204s18]> select * from employees where employee_id in (select distinct(manager_id) from employees where manager_id != 0); 
+-------------+------------+-----------+----------+--------------------+------------+---------+----------+----------------+------------+---------------+
| EMPLOYEE_ID | FIRST_NAME | LAST_NAME | EMAIL    | PHONE_NUMBER       | HIRE_DATE  | JOB_ID  | SALARY   | COMMISSION_PCT | MANAGER_ID | DEPARTMENT_ID |
+-------------+------------+-----------+----------+--------------------+------------+---------+----------+----------------+------------+---------------+
|         100 | Steven     | King      | SKING    | 515.123.4567       | 1987-06-17 | AD_PRES | 24000.00 |           0.00 |          0 |            90 |
...
MariaDB [csd2204s18]> seslect employee_id , first_name, last_name from employees where department_id = (select department_name , department_id from departments);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'seslect employee_id , first_name, last_name from employees where department_id =' at line 1
MariaDB [csd2204s18]> select employee_id , first_name, last_name from employees where department_id = (select department_name , department_id from departments);
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]> select employee_id , first_name, last_name from employees where department_id = (select department_name  from departments);
ERROR 1242 (21000): Subquery returns more than 1 row
...
MariaDB [csd2204s18]> select employee_id , first_name, last_name,department_id from employees where departments.department_id = employees.department_id
    -> ;
...
MariaDB [csd2204s18]> select employee_id , first_name, last_name,department_id ,(select department_name from departments d where d.department_id = e.department_id)"department name" from employees e;
+-------------+-------------+-------------+---------------+------------------+
| employee_id | first_name  | last_name   | department_id | department name  |
+-------------+-------------+-------------+---------------+------------------+
...
|         116 | Shelli      | Baida       |            30 | Purchasing       |
|         117 | Sigal       | Tobias      |            30 | Purchasing       |
|         118 | Guy         | Himuro      |            30 | Purchasing       |
|         119 | Karen       | Colmenares  |            30 | Purchasing       |
|         120 | Matthew     | Weiss       |            50 | Shipping         |
|         121 | Adam        | Fripp       |            50 | Shipping         |
|         122 | Payam       | Kaufling    |            50 | Shipping         |
|         123 | Shanta      | Vollman     |            50 | Shipping         |
|         124 | Kevin       | Mourgos     |            50 | Shipping         |
|         125 | Julia       | Nayer       |            50 | Shipping         |
|         126 | Irene       | Mikkilineni |            50 | Shipping         |
|         127 | James       | Landry      |            50 | Shipping         |
|         128 | Steven      | Markle      |            50 | Shipping         |
|         129 | Laura       | Bissot      |            50 | Shipping         |
|         130 | Mozhe       | Atkinson    |            50 | Shipping         |
|         131 | James       | Marlow      |            50 | Shipping         |
|         132 | TJ          | Olson       |            50 | Shipping         |
|         133 | Jason       | Mallin      |            50 | Shipping         |
|         134 | Michael     | Rogers      |            50 | Shipping         |
|         135 | Ki          | Gee         |            50 | Shipping         |
|         136 | Hazel       | Philtanker  |            50 | Shipping         |
|         137 | Renske      | Ladwig      |            50 | Shipping         |
|         138 | Stephen     | Stiles      |            50 | Shipping         |
|         139 | John        | Seo         |            50 | Shipping         |
|         140 | Joshua      | Patel       |            50 | Shipping         |
|         141 | Trenna      | Rajs        |            50 | Shipping         |
|         142 | Curtis      | Davies      |            50 | Shipping         |
|         143 | Randall     | Matos       |            50 | Shipping         |
|         144 | Peter       | Vargas      |            50 | Shipping         |
|         145 | John        | Russell     |            80 | Sales            |
|         146 | Karen       | Partners    |            80 | Sales            |
|         147 | Alberto     | Errazuriz   |            80 | Sales            |
|         148 | Gerald      | Cambrault   |            80 | Sales            |
|         149 | Eleni       | Zlotkey     |            80 | Sales            |
|         150 | Peter       | Tucker      |            80 | Sales            |
|         151 | David       | Bernstein   |            80 | Sales            |
|         152 | Peter       | Hall        |            80 | Sales            |
|         153 | Christopher | Olsen       |            80 | Sales            |
|         154 | Nanette     | Cambrault   |            80 | Sales            |
|         155 | Oliver      | Tuvault     |            80 | Sales            |
|         156 | Janette     | King        |            80 | Sales            |
|         157 | Patrick     | Sully       |            80 | Sales            |
|         158 | Allan       | McEwen      |            80 | Sales            |
|         159 | Lindsey     | Smith       |            80 | Sales            |
|         160 | Louise      | Doran       |            80 | Sales            |
|         161 | Sarath      | Sewall      |            80 | Sales            |
|         162 | Clara       | Vishney     |            80 | Sales            |
|         163 | Danielle    | Greene      |            80 | Sales            |
|         164 | Mattea      | Marvins     |            80 | Sales            |
|         165 | David       | Lee         |            80 | Sales            |
|         166 | Sundar      | Ande        |            80 | Sales            |
|         167 | Amit        | Banda       |            80 | Sales            |
|         168 | Lisa        | Ozer        |            80 | Sales            |
|         169 | Harrison    | Bloom       |            80 | Sales            |
|         170 | Tayler      | Fox         |            80 | Sales            |
|         171 | William     | Smith       |            80 | Sales            |
|         172 | Elizabeth   | Bates       |            80 | Sales            |
|         173 | Sundita     | Kumar       |            80 | Sales            |
|         174 | Ellen       | Abel        |            80 | Sales            |
|         175 | Alyssa      | Hutton      |            80 | Sales            |
|         176 | Jonathon    | Taylor      |            80 | Sales            |
|         177 | Jack        | Livingston  |            80 | Sales            |
|         178 | Kimberely   | Grant       |             0 | NULL             |
|         179 | Charles     | Johnson     |            80 | Sales            |
|         180 | Winston     | Taylor      |            50 | Shipping         |
|         181 | Jean        | Fleaur      |            50 | Shipping         |
|         182 | Martha      | Sullivan    |            50 | Shipping         |
|         183 | Girard      | Geoni       |            50 | Shipping         |
|         184 | Nandita     | Sarchand    |            50 | Shipping         |
|         185 | Alexis      | Bull        |            50 | Shipping         |
|         186 | Julia       | Dellinger   |            50 | Shipping         |
|         187 | Anthony     | Cabrio      |            50 | Shipping         |
|         188 | Kelly       | Chung       |            50 | Shipping         |
|         189 | Jennifer    | Dilly       |            50 | Shipping         |
|         190 | Timothy     | Gates       |            50 | Shipping         |
|         191 | Randall     | Perkins     |            50 | Shipping         |
|         192 | Sarah       | Bell        |            50 | Shipping         |
|         193 | Britney     | Everett     |            50 | Shipping         |
|         194 | Samuel      | McCain      |            50 | Shipping         |
|         195 | Vance       | Jones       |            50 | Shipping         |
|         196 | Alana       | Walsh       |            50 | Shipping         |
|         197 | Kevin       | Feeney      |            50 | Shipping         |
|         198 | Donald      | OConnell    |            50 | Shipping         |
|         199 | Douglas     | Grant       |            50 | Shipping         |
|         200 | Jennifer    | Whalen      |            10 | Administration   |
|         201 | Michael     | Hartstein   |            20 | Marketing        |
|         202 | Pat         | Fay         |            20 | Marketing        |
|         203 | Susan       | Mavris      |            40 | Human Resources  |
|         204 | Hermann     | Baer        |            70 | Public Relations |
...
MariaDB [csd2204s18]> select * from employees where salary> (select avg(salary) from employees group by department_id);
ERROR 1242 (21000): Subquery returns more than 1 row
MariaDB [csd2204s18]> select * from employees where salary in (select avg(salary) from employees group by department_id);
+-------------+------------+-----------+----------+--------------------+------------+---------+----------+----------------+------------+---------------+
| EMPLOYEE_ID | FIRST_NAME | LAST_NAME | EMAIL    | PHONE_NUMBER       | HIRE_DATE  | JOB_ID  | SALARY   | COMMISSION_PCT | MANAGER_ID | DEPARTMENT_ID |
+-------------+------------+-----------+----------+--------------------+------------+---------+----------+----------------+------------+---------------+
|         123 | Shanta     | Vollman   | SVOLLMAN | 650.123.4234       | 1987-07-10 | ST_MAN  |  6500.00 |           0.00 |        100 |            50 |
...
MariaDB [csd2204s18]> select distinct(department_name) from departments;
+----------------------+
| department_name      |
+----------------------+
| Administration       |
...
MariaDB [csd2204s18]> select * from employees e where salary > (select avg(salary) from employees group by department_id having department_id= e.department_id); 
+-------------+------------+-----------+----------+--------------------+------------+------------+----------+----------------+------------+---------------+
| EMPLOYEE_ID | FIRST_NAME | LAST_NAME | EMAIL    | PHONE_NUMBER       | HIRE_DATE  | JOB_ID     | SALARY   | COMMISSION_PCT | MANAGER_ID | DEPARTMENT_ID |
+-------------+------------+-----------+----------+--------------------+------------+------------+----------+----------------+------------+---------------+
|         100 | Steven     | King      | SKING    | 515.123.4567       | 1987-06-17 | AD_PRES    | 24000.00 |           0.00 |          0 |            90 |
...
MariaDB [csd2204s18]> select department_name,department_id from departments where department_id not in (select department_id from employees group by department_id);
+----------------------+---------------+
| department_name      | department_id |
+----------------------+---------------+
| Treasury             |           120 |
...
MariaDB [csd2204s18]> select distinct(salary) from employees order by salary aac limit 3;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'aac limit 3' at line 1
MariaDB [csd2204s18]> select distinct(salary) from employees order by salary asc limit 3;
+---------+
| salary  |
+---------+
| 2100.00 |
...
MariaDB [csd2204s18]> select distinct(salary) from employees order by salary asc limit 5;
+---------+
| salary  |
+---------+
| 2100.00 |
...
MariaDB [csd2204s18]> select distinct(salary) from employees order by salary desc limit 5;
+----------+
| salary   |
+----------+
| 24000.00 |
