...
MariaDB [csd2204s18]> select products.Code,product.Name,manu.name from manu inner join on products.code = manu.code;
...
MariaDB [csd2204s18]> select products.Code,product.Name,manu.name from manu inner join on products.Code = manu.Code;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'on products.Code = manu.Code' at line 1
MariaDB [csd2204s18]> select products.Code,product.Name,manu.name from manu inner join products on products.Code = manu.Code;
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer group by manufacturer; 
+--------------+-------------------+--------------+
| manufacturer | name              | no. of items |
+--------------+-------------------+--------------+
|            1 | Sony              |            1 |
|            2 | Creative Labs     |            3 |
|            3 | Hewlett-Packard   |            2 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where m.code<4  group by manufacturer ; 
+--------------+-----------------+--------------+
| manufacturer | name            | no. of items |
+--------------+-----------------+--------------+
|            1 | Sony            |            1 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where m.code>2  group by manufacturer ; 
+--------------+-------------------+--------------+
| manufacturer | name              | no. of items |
+--------------+-------------------+--------------+
|            3 | Hewlett-Packard   |            2 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p where p.manufacturer>2 inner join manu m on  m.code=p.manufacturer  group by manufacturer ; 
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'inner join manu m on  m.code=p.manufacturer  group by manufacturer' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where p.manufacturer>2  group by products ; 
ERROR 1054 (42S22): Unknown column 'products' in 'group statement'
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where p.manufacturer>2  group by manufacturer ; 
+--------------+-------------------+--------------+
| manufacturer | name              | no. of items |
+--------------+-------------------+--------------+
|            3 | Hewlett-Packard   |            2 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer group by manufacturer having count(*)> 2; 
+--------------+-------------------+--------------+
| manufacturer | name              | no. of items |
+--------------+-------------------+--------------+
|            2 | Creative Labs     |            3 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where m.code in(2,3) group by manufacturer ; 
+--------------+-----------------+--------------+
| manufacturer | name            | no. of items |
+--------------+-----------------+--------------+
|            2 | Creative Labs   |            3 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where m.code 2,3 group by manufacturer ; 
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '2,3 group by manufacturer' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where m.code (2,3) group by manufacturer ; 
ERROR 1630 (42000): FUNCTION m.code does not exist. Check the 'Function Name Parsing and Resolution' section in the Reference Manual
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where m.code in(2,3) group by manufacturer ; 
+--------------+-----------------+--------------+
| manufacturer | name            | no. of items |
+--------------+-----------------+--------------+
...
MariaDB [csd2204s18]> select manufacturer, m.name, count(*) "no. of items" from products as p inner join manu m on  m.code=p.manufacturer where m.code in(2,3)  ; 
+--------------+---------------+--------------+
| manufacturer | name          | no. of items |
+--------------+---------------+--------------+
|            2 | Creative Labs |            5 |
...
MariaDB [csd2204s18]> select products.Code,product.Name,manu.name from manu left join products on products.Code = manu.Code;
ERROR 1054 (42S22): Unknown column 'product.Name' in 'field list'
...
MariaDB [csd2204s18]> select p.Code,p.Name,m.name from manu m right join products p on p.manufacturer = m.Code;
+------+-----------------+-------------------+
| Code | Name            | name              |
+------+-----------------+-------------------+
|    1 | Hard drive      | Fujitsu           |
...
MariaDB [csd2204s18]> select p.Code,p.Name,m.name from products p left join manu m on p.code = m.Code union select p.code,p.name,m.name from products p right join manu m on p.code=m.code;
+------+-----------------+-------------------+
| Code | Name            | name              |
+------+-----------------+-------------------+
|    1 | Hard drive      | Sony              |
